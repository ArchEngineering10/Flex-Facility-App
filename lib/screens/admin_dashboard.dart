...
class _AdminDashboardState extends State<AdminDashboard> {
  ...
  /// Messages tile with a live unread-count badge.
  Widget _buildMessagesTile(BuildContext context) {
    const gradientColors = [Color(0xFF1C2D5E), Color(0xFF4A6FD4)];
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snap) {
        ...
        if (snap.hasData) {
          for (final doc in snap.data!.docs) {
            ...
            totalUnread += (data['unreadAdmin'] as int? ?? 0);
          }
        }
        return SizedBox(
              ...
              Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color:
                          const Color(0xFF1C2D5E).withValues(alpha: 0.12),
                      blurRadius: 10,
                      offset: const Offset(0, 4),
                    ),
                  ],
